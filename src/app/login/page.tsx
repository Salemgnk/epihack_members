...
import { Shield, Zap, Users, Terminal, AlertTriangle } from 'lucide-react';
                ...
                <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-lg p-8 shadow-2xl">
                    {rickrolled && (
                        <div className="mb-6 p-4 bg-red-500/10 border border-red-500/30 rounded-lg flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-sm text-red-400 font-semibold">Nice try! 😏</p>
                                <p className="text-xs text-red-300/70">You've been rickrolled!</p>
                            </div>
                        </div>
                    )}
